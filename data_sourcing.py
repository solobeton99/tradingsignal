...
def update_market_data(data):
    ...
    if data == 'crypto':
        ...
        try:
            ...
            df_stocks.to_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/snp500.txt', index = False)
        except:
            pass
        ...
        try:
            ...
            df_futures.to_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/testonly/market_data/market_data/futures.txt', index = False)
        except:
            pass
...
def data_update():
    df_crypto = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/crypto.txt')
    df_stocks = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/snp500.txt')
    df_indexes = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/indexes.txt')
    df_futures = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/futures.txt')
    df_forex = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/forex.txt')
...
class Data_Sourcing:
    def __init__(self):
        self.df_crypto = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/crypto.txt')
        self.df_stocks = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/snp500.txt')
        self.df_indexes = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/indexes.txt')
        self.df_futures = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/futures.txt')
        self.df_forex = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/technical-analysis-master/market_data/forex.txt')
