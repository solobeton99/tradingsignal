...
class CryptoApp(HydraHeadApp):
    ...
    def run(self):
        ...
        currency_pair = pd.read_csv('/Users/administrator/PycharmProjects/MultipleApp/financialdashboard/hydralit-example-main/test-hydralit-working/crypto2.csv')

        symbol = st.selectbox('Select the Currency Pairs', currency_pair).upper()

        exchange = st.selectbox("Exchange", ("BINANCE", "COINBASE", "COINEX", "BINGX", "KUCOIN", "UNISWAP", "POLONIEX", "BITTREX", "HUOBI"))
        screener = "crypto"
