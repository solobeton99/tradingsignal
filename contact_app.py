...
#wrap all your code in this method and you should be done
    def run(self):
        ...
        def suggest_trade(possible_trades):
            ...
            st.header("Highest profit trade is with: " + max_profit_ticker + " for a profit of " + str(max_profit))
            st.subheader(
                "Buy " + max_profit_ticker + " on " + max_profit_lowExchange + " and Sell on " + max_profit_highExchange)
